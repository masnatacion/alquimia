...
JSONeditorB={
	...
	//Cambiar por acciones dinamicas
	formHTML:"<form name=\"jsoninputB\" onsubmit=\"return treeBuilder.jsonChange(this)\"> "+
	"Label:<br><input name=\"jlabel\" type=\"text\" value=\"\" size=\"60\" style=\"width:290px\"><br><br>"+
	"Value:<br><textarea name=\"jvalue\" rows=\"10\" cols=\"50\" style=\"width:290px\"></textarea><br><br>"+
	"Data type: <select onchange=\"treeBuilder.changeJsonDataType(this.value,this.parentNode)\" name=\"jtype\">"+
	"<option value=\"object\">object</option><option value=\"array\">array</option><option value=\"function\">"+
	"function</option><option value=\"string\">string</option><option value=\"number\">number</option>"+
	"<option value=\"boolean\">boolean</option><option value=\"null\">null</option><option value=\"undefined\">"+
	"undefined</option></select><input name=\"orgjlabel\" type=\"hidden\" value=\"\" size=\"50\" style=\"width:290px\">"+
	"<input onfocus=\"this.blur()\" type=\"submit\" value=\"Save\">&nbsp;<br><br>"+
	...
	"<br><br><input name=\"jRemove\" onfocus=\"this.blur()\" type=\"button\" onclick=\"treeBuilder.jsonRemove(this.parentNode)\" value=\"Delete\">&nbsp;"+
	...
	"<br><br><input type=\"checkbox\" name=\"jbefore\">Nodos hijo antes / Nodos hermanos despues<br><input type=\"checkbox\" name=\"jPasteAsChild\">"+
	"Pegar como hijos sobre objetos y arreglos<br><br><div id=\"jformMessage\"></div></form>"
}

JSONeditorB.treeBuilder={
	stateMem:{},
	images:{
		folderNode:'',
		folderNodeOpen:'',
	...
	jsonResponder:function(x){
		...
		if(a===null){t="null"}
		var f=document.forms.jsoninputB
...
JSONeditorB.treeBuilder.JSONstring={
	compactOutput:false, 		
	includeProtos:false, 	
