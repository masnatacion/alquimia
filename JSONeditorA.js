...
JSONeditorA={
	...
	formHTML:"<form name=\"jsoninputA\" onsubmit=\"return treeBuilder.jsonChange(this)\"> "+
...
JSONeditorA.treeBuilder={
	...
	jsonResponder:function(x){
		...
		if(a===null){t="null"}
		var f=document.forms.jsoninputA
...
JSONeditorA.treeBuilder.JSONstring={
	compactOutput:false, 		
	includeProtos:false, 	
